document.querySelectorAll('.view-details').forEach(button => {
    button.addEventListener('click', function (event) {
      ...
      const startDate = card.querySelector('.card-text').textContent.replace('Starting ', '');
      ...
      const courseData = {
        ...
        description: "Learn the fundamentals of Illustrator to create stunning graphics.",
